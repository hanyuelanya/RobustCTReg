...
class Dataloader():
    ...
    def __GetVolPath(self,case='1',T='00'):
        ...
        if self.dataset=='dirlab':
            ...
            if self.resample:
                volpath = os.path.join(root, "Copd{0}Pack".format(case), "Resample", "C{0}T{1}_r.mha".format(case, T))
            else:
                volpath = os.path.join(root, "Copd{0}Pack".format(case), "Mha", "C{0}T{1}.mha".format(case, T))
        print("loading image at",volpath)
        return volpath
    ...
    def __GetPtsPath(self,case='1',T='00'):
        ...
        if self.dataset=='dirlab':
            ...
            return os.path.join(root, "Copd{0}Pack".format(case), "Pts", "C{0}T{1}_300.pts".format(case, T))
    ...
    def __GetLungMaskPath(self,case='1',T='00'):
        ...
        if self.dataset=='dirlab':
            ...
            return os.path.join(root, "Copd{0}Pack".format(case), "LungMask",
                                "C{0}T{1}_r_lung_mask.mha".format(case, T))
    ...
    def __GetBoneMaskPath(self,case='1',T='00'):
        ...
        if self.dataset=='dirlab':
            ...
            return os.path.join(root,"Copd{0}Pack".format(case),"BoneMask","C{0}T{1}_r_bone_mask.mha".format(case,T))
